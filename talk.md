...
---
# pyhf and Combine interoperability
...
<!--  -->
.kol-1-3.large[
.center.width-100[[![numfocus-tile-view](figures/numfocus-tile-view.png)](https://numfocus.org/sponsored-projects/affiliated-projects)]
]
.kol-2-3.large[

.center.width-80[[![numfocus-logo](figures/numfocus-logo.png)](https://numfocus.org/)]

.italic[The mission of NumFOCUS is to promote open practices in research, data, and scientific computing by serving as a fiscal sponsor for open source projects and organizing community-driven educational programs.]

- Became [NumFOCUS Affiliated Project](https://numfocus.org/sponsored-projects/affiliated-projects) in December, 2022
   - As a project committed to creating an open user and contributor community that embraces the best practices of open source
   - First Scikit-HEP project, followed in early 2023 by Awkward Array
]
...
---
# Combine dev team thoughts (2021)
